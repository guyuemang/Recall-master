...
import recall.utils.file.FileUtils;
...
public class ShaderUtils implements Instance {
    ...
    public ShaderUtils(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("nothing/shaders/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
