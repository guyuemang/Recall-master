    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        for (String text : setting.getModes()) {
            ...
            if (text.equals(setting.get())) {
                FontManager.Bold.get(13).drawString(text, getX() + offset + 8, getY() + FontManager.Bold.get(15).getHeight() + heightoff, InterFace.mainColor.get().brighter().brighter().brighter().getRGB());
            } else {
