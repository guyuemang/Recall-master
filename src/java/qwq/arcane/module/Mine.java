    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        AchievementList.openInventory.setStatStringFormatter(new IStatStringFormat()
        {
            public String formatString(String str)
            {
                try
                {
                    return String.format(str, new Object[] {GameSettings.getKeyDisplayString(Mine.this.gameSettings.keyBindInventory.getKeyCode())});
                }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                return !s.equals("vanilla") ? "Definitely; Client brand changed to \'" + s + "\'" : (Mine.class.getSigners() == null ? "Very likely; Jar signature invalidated" : "Probably not. Jar signature remains and client brand is untouched.");
            }
        });
